...
interface Fifa07GameProps {
  onBack: () => void;
}

const Fifa07Game: React.FC<Fifa07GameProps> = ({ onBack }) => {
	...
	<script>
		document.getElementById("game").style.display = "none";
            function startGame() {
                ...
                EJS_gameUrl = "https://cdn.jsdelivr.net/gh/bubbls/UGS-file-encryption@00a3d67c0fd4d32c1c80cfaac2ebcc308c83bf7a/World%20Cup%2098%20(USA)%20(En%2CFr%2CDe%2CEs%2CIt%2CNl%2CSv%2CDa).zip";
                loadGame(); 
            }
