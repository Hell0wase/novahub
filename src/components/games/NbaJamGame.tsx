...
interface NbaJamGameProps {
  onBack: () => void;
}

const NbaJamGame: React.FC<NbaJamGameProps> = ({ onBack }) => {
	...
	<script>
		document.getElementById("game").style.display = "none";
            function startGame() {
                ...
                EJS_gameUrl = "https://cdn.jsdelivr.net/gh/bubbls/classroom6xarchive@f91e2aec4fff3d3158f26cb9a76b99fa71ca81fa/NBA%20Jam%20(USA).zip";
                loadGame(); 
            }
