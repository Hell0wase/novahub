...
<body>
    ...
    <div id="game-container">
        <ruffle-embed src="https://cdn.jsdelivr.net/gh/markrosenbaum/some-repo@aeb3030a3fb90987658ff4ee1063c64f6206152f/dl2/ducklife2worldchampion.swf" width="100%" height="100%"></ruffle-embed>
    </div>
</body>
</html>
    `;
  ...
  return (
    <FullscreenGame gameName="Duck Life 2" onBack={onBack}>
      <iframe
        ref={iframeRef}
