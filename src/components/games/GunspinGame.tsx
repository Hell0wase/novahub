...
interface GunspinGameProps {
  onBack: () => void;
}

const GunspinGame: React.FC<GunspinGameProps> = ({ onBack }) => {
...
<head>
	...
	<link
		href="https://cdn.jsdelivr.net/gh/sidharthkiscool/monkeygg2.github.io@762aa28c099959eb0d64028560f0d61b195b02da/games/gunspin/TemplateData/style.css"
		rel="stylesheet">
	<meta charset="utf-8">
...
<body dir="ltr">
	<script
		src="https://cdn.jsdelivr.net/gh/sidharthkiscool/monkeygg2.github.io@762aa28c099959eb0d64028560f0d61b195b02da/games/gunspin/TemplateData/UnityProgress.js">
	</script>
	<script
		src="https://cdn.jsdelivr.net/gh/sidharthkiscool/monkeygg2.github.io@762aa28c099959eb0d64028560f0d61b195b02da/games/gunspin/Build/UnityLoader.js">
	</script>
	<script>
	...
	<div class="webgl-content">
		<div id="unityContainer"
			style="width: 100vw; height: 100vh; padding: 0px; margin: 0px; border: 0px; position: relative; background: rgb(35, 31, 32);">
			<canvas id="#canvas" style="width: 100%; height: 100%; cursor: default;" width="614" height="919"></canvas>
			<div
