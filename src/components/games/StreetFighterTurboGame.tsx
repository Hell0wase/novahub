...
interface StreetFighterTurboGameProps {
  onBack: () => void;
}

const StreetFighterTurboGame: React.FC<StreetFighterTurboGameProps> = ({ onBack }) => {
	...
	<script>
		document.getElementById("game").style.display = "none";
            function startGame() {
                ...
                EJS_gameUrl = "https://cdn.jsdelivr.net/gh/bubbls/UGS-file-encryption@f4aacc371b8cbd4027367a08dc73d69eab9fa7a4/Street%20Fighter%20II%20Turbo%20(USA).zip";
                loadGame(); 
            }
  ...
  return (
    <div className="w-full h-full">
      <iframe
        ...
        title="Street Fighter Turbo Game"
      />
    </div>
  );
};

export default StreetFighterTurboGame;